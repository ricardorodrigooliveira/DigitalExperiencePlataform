<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    ...
    <div class="navbar-header">
        ...
        <a class="navbar-brand" href="../index.php">Nosso CMS</a>
    </div>
    <!-- Top Menu Items -->
    <ul class="nav navbar-right top-nav">
      ...
      <li><a href="../index.php">HOME</a></li>
        ...
        <li class="dropdown">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user"></i> Ricardo Oliveira <b class="caret"></b></a>
        ...
        <ul class="nav navbar-nav side-nav">
            ...
            <li>
                ...
                <ul id="posts" class="collapse">
                    <li>
                        <a href="../admin/add_posts.php">Adicionar Posts</a>
                    </li>
                    <li>
            ...
            <li>
                ...
                <ul id="users" class="collapse">
                    <li>
                        <a href="../admin/usuarios.php">Adicionar usupario</a>
                    </li>
                    <li>
                        <a href="../admin/usuarios.php">Ver todos os usuários</a>
                    </li>
                </ul>
            </li>
            <li class="active">
            ...
            <li>
                <a href="../admin/categorias.php"><i class="fa fa-fw fa-dashboard"></i> Perfil</a>
            </li>
        </ul>
    </div>
    <!-- /.navbar-collapse -->
